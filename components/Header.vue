      ...
      <div class="col-12">
        <ul class="d-flex list-unstyled mb-0 menu justify-content-center">
          ...
          <li class="me-3 dropdown">
            <a href="#" class="btn text-white p-2 dropdown-toggle">Profil</a>
            <ul class="dropdown-menu">
              <li>
                <NuxtLink to="/sejarah" class="dropdown-item">Sejarah</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/profil" class="dropdown-item">Identitas Sekolah</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/visimisi" class="dropdown-item">Visi dan Misi</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/galeri" class="dropdown-item">Galeri</NuxtLink>
              </li>
            </ul>
          </li>
          <li class="me-3">
            <NuxtLink to="/guru" class="nav-link text-white">Guru</NuxtLink>
          </li>
          <li class="me-3">
            <NuxtLink to="/berita" class="nav-link text-white">Berita</NuxtLink>
          </li>
          <li class="me-3">
